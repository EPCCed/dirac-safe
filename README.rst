...
This repository contains the documentation for the DiRAC service management web interface and is linked to a rendered version on ReadTheDocs.
...
* `DiRAC SAFE Documentation (HTML) on ReadTheDocs <http://diracsafe.readthedocs.io/>`_
* `DiRAC SAFE Documentation (PDF) on ReadTheDocs <https://readthedocs.org/projects/diracsafe/downloads/pdf/latest/>`_
